...
which is $M_{VV_p}$, coded as \mintinline{julia}/M[V_p, V]/,
to represent the the aforementioned idea.

Finally, we apply the damping factor to the matrix.
Since the damping factor represents the probability that a surfer will continue surfing at any given vertex,
