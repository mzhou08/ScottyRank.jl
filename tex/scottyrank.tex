...
In our general PageRank algorithm, we will use the PageRank matrix generated from the user-provided graph.



\subsubsection{PageRank - Iterative Variation}
...
\end{minted}
 ...
 \subsubsection{Pagerank - Epsilon Variation}
