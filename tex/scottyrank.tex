...
\subsection{Reading Graphs and Vertices from Files}
...
\subsection{PageRank Matrix Generation}

The function pagerank\_matrix generates a Markov Matrix that will be used in the PageRank algorith,.
