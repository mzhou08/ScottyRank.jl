...
In the Epsilon variation of our PageRank implementation, instead of multiplying the Markov Matrices a fixed amount of times, we conue multiplying the expression $M^k(1/n, 1/n, ... 1/n)$ by $M$ on the left until the norm of the difference between the vector $M^{k+1}(1/n, 1/n, ... 1/n)$ and the matrix $M^k(1/n, 1/n, ... 1/n)$ is less than a caller-specified limit, which is the value of Epsilon.
